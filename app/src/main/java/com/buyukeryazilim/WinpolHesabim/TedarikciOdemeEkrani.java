...
public class TedarikciOdemeEkrani extends AppCompatActivity {
    ...
    public void odemeYapButtonClick(View view) {
        ...
        myRef.child(firebaseAuth.getCurrentUser().getUid()).child("TedarikciKasa").child(musteriName).child("borç").setValue(Integer.toString(toplamBorcInt-odenecekTutarInt));
